...
=================================
⚠️ DEPRECATED (2026-07-18): 本文件被生产环境否决并已被 validation-v3 闭环取代。
已知问题: 1)特征抽取为内联简化版, 与训练特征口径不一致;
2)回证为近似空实现(只统计pending不执行验证); 3)LLM回证证据链脆弱。
保留仅为审计可追溯。生产实现见 README "2026-07-18 Metric Correction & validation-v3" 一节。
